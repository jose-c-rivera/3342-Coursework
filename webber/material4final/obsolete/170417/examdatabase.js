var examdatabase =
{
  ...
  "questions": [
     ...
     {
        "question": "In Haskell, how would you write an anonymous function so that the expression `map ANSWER [1, 2, 3]' produces [-4, -5, -6].",
        "lquestion": "In Haskell, how would you write an anonymous function so that the expression `map ANSWER $\\lbrack 1, 2, 3\\rbrack$' produces $\\lbrack -4, -5, -6\\rbrack$.",
        "answer": "(\\x -> - (x + 3))",
        "lanswer": "$(\\ x \\rightarrow - (x + 3))$",
     ...
     },
     {
        ...
        "lanswer": "$E \\rightarrow E + F$ and $E \\rightarrow F$ and $F \\rightarrow id$",
     ...
     },
     {
        ...
        "lanswer": ["cat(What).", "cats(What).", "is\\_a(What, cat).", "are(What, cats)."],
        "note": "optional note",
        "source": "SLSW4"
     },
     {
     ...
     {
        "question": "Using the straightfoward expression translation scheme in the textbook, if I were to TransExp('3 * x + 1', vtable, ftable), newvar() will be invoked ANSWER times.",
        "answer": "5",
        "note": "optional note",
        "source": "ICD6"
     },
     {
        "question": "Using the straightfoward statement translation scheme in the textbook, if I were to TransStat('if true then z := 1 else z := 2', vtable, ftable), newlabel() be invoked ANSWER times.",
        "answer": "3",
        "note": "optional note",
        "source": "ICD6"
     },
     {
        "question": "Using the straightfoward statement translation scheme in the textbook, if I were to TransStat('while true do z := 1 + z', vtable, ftable), newlabel() be invoked ANSWER times.",
        "answer": "3",
        "note": "optional note",
        "source": "ICD6"
     },
     {
        "question": "Using the straightfoward statement translation scheme in the textbook, if I were to TransStat('while z < 3 do z := 1 + z', vtable, ftable), newvar() be invoked ANSWER times.",
        "lquestion": "Using the straightfoward statement translation scheme in the textbook, if I were to TransStat('while z $<$ 3 do z := 1 + z', vtable, ftable), newvar() be invoked ANSWER times.",
        "answer": "5",
        "note": "optional note",
        "source": "ICD6"
     },
     {
        "question": "Type checking done during program execution is called ANSWER.",
        "answer": "dynamic typing",
        "note": "optional note",
        "source": "ICD5"
     },
     {
        "question": "Type checking done during program compilation is called ANSWER.",
     ...
     {
        "question": "The portion of the call stack associated with a single function invocation and running is called ANSWER.",
